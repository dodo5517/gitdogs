<g transform="translate(-342,50)">
  ...
  <!-- 제자리에서 킁킁거리는 다크 카라멜 골든 리트리버 (Sniff) / 투명 배경 / SMIL 전용 -->
  <!-- 6px 격자 기반: 모든 rect 좌표와 크기는 6의 배수, 픽셀 틈새 0% -->
  <!-- 코끝은 0.4초 주기로 씰룩, 꼬리는 0.8초 주기로 살랑살랑 -->
  ...
  <g transform="translate(340, 0)">
    ...
    <g>
      <!-- 뒷다리 -->
      <rect x="48" y="42" width="12" height="24" fill="#D48C3D"/> <!-- 왼 (Foreground) -->
      <rect x="60" y="42" width="12" height="24" fill="#AA6323"/> <!-- 오른 (Background) -->
      <!-- 앞다리 -->
      <rect x="96" y="42" width="12" height="24" fill="#D48C3D"/> <!-- 왼 (Foreground) -->
      <rect x="108" y="42" width="12" height="24" fill="#AA6323"/> <!-- 오른 (Background) -->
    </g>
    ...
    <g>
      ...
      <!-- 킁킁거리는 코끝 애니메이션 (0.4초 주기 빠른 씰룩임) -->
      <g>
        <!-- 프레임 1: 코가 땅(y=66)에 닿은 상태 -->
        <g>
